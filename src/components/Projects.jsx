...
const PORTFOLIO_FEATURES = [
  {
    ...
    description: "Architecting high-performance, responsive interfaces and modular design systems for low-latency, data-intensive applications.",
  },
  {
    id: "data-analytics",
    area: "md:[grid-area:1/7/2/13] xl:[grid-area:2/1/3/5]",
    icon: <Settings className="h-4 w-4 text-cyan-300" />,
    title: "Data Engineering & AI Systems",
    description: "Designing fault-tolerant, production-grade LLM orchestrators, deterministic data pipelines, and predictive machine learning models.",
  },
  {
    id: "research-synthesis",
    area: "md:[grid-area:2/1/3/7] xl:[grid-area:1/5/3/8]",
    icon: <Search className="h-4 w-4 text-cyan-300" />,
    title: "Systems Research & Synthesis",
    description: "Translating complex hardware and software landscape data into actionable engineering frameworks and automation strategies.",
  },
  {
    id: "tech-leadership",
    ...
    description: "Distilling complex engineering trends, market signals, and systems architecture into accessible frameworks to guide strategic direction.",
  },
  {
    id: "agile-management",
    ...
    description: "Driving rapid iterative development, managing Git workflows, and leading cross-functional engineering teams to ship scalable production platforms.",
  },
];
